    ...
    <div class="row">
            ...
            <div class="card-group mb-3">
                <div class="card">
                    ...
                    <div class="card-body fw-bold">
                        <small><a class="link text-decoration-none text-dark" href="#">JUDUL FOTO 1</a></small>
                    </div>
                </div>
                <div class="card">
                    <img src="./img/content.jpg" class="card-img-top" alt="..." />
                    <div class="card-body fw-bold">
                        <small><a class="link text-decoration-none text-dark" href="#">JUDUL FOTO 2</a></small>
                    </div>
                </div>
                <div class="card">
                    <img src="./img/content.jpg" class="card-img-top" alt="..." />
                    <div class="card-body fw-bold">
                        <small><a class="link text-decoration-none text-dark" href="#">JUDUL FOTO 3</a></small>
                    </div>
                </div>
            </div>
            <div class="text-center my-3"><a class="text-white fw-bold text-decoration-none" href="#">Lihat
                    Selengkapnya</a>
            </div>
        </div>
        <!--advertisement-->
        <div class="col">
            <div class="text-center my-3 fw-bold" style="background-color: rgba(210, 210, 210, 0.803)">
                <small>advertisement</small>
                <div>
                    <img src="./img/ads/homepage3-ads.jpg" class="img-fluid mb-3" alt="" />
                </div>
            </div>
        </div>
        <!--advertisement end-->
        ...
        <div class="col-md-8">
            ...
            <div class="card-group">
                <div class="card">
                    <img src="./img/content.jpg" class="card-img-top" alt="..." />
                    <div class="card-body fw-bold">
                        <small><a class="link text-decoration-none text-dark" href="#">JUDUL PILIHAN EDITOR
                                1</a></small>
                    </div>
                </div>
                <div class="card">
